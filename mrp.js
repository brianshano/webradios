...
(function(e, f, x) {
    ...
    d.setTitle = function(a) {
        ...
        d.flashInstances.exists(d.objectId) &&
        d.flashInstances.get(d.objectId).setTitle(a)
    };
    d.setUrl = function(a) {
    ...
    d.insert = function(a) {
        ...
        if (0 < d.isIE() && 11 > d.isIE()) e.log("MusesRadioPlayer will use Flash Version here since you have Internet Explorer " + d.isIE() + " (wich is older than IE 11)."), d.flashInsert(a);
        else if (0 < d.isIE() && 11 <= d.isIE() && "aac" == a.codec && FlashDetect.versionAtLeast(10,
                1)) e.log("MusesRadioPlayer will use Flash Version here since you have Internet Explorer " + d.isIE() + " (wich claims to support AAC but it doesn't support it right)."), d.flashInsert(a);
        else {
    ...
    Q.prototype = {
        ...
        setSitespeedSampleRate: function(a) {
            0 > a || 100 < a ? A._raiseError("For consistency with ga.js, sample rates must be specified as a number between 0 and 100.",
                "config.setSitespeedSampleRate") : this.sitespeedSampleRate = a
        },
        __class__: Q
    };
    var R = function(a) {
    ...
    Oa.prototype = {
        ...
        fromUtma: function(a) {
            a = a.split(".");
            if (6 != a.length) return A._raiseError('The given "__utma" cookie value is invalid.', "Visitor.fromUtma"), this;
    ...
    ca.prototype = {
        ...
        toQueryString: function() {
            for (var a =
                "", b = 0, c = La.getInstanceFields(ca); b < c.length;) {
                var h = c[b];
                ++b;
    ...
    B.generateHash = function(a) {
        var b = 1,
            c;
        if (null != a && "" != a)
            for (var b = 0, h = a.length - 1; 0 <= h;) c = q.cca(a, h), b = (b << 6 & 268435455) + c + (c << 14), c = b & 266338304, 0 != c && (b ^= c >> 21), h--;
        return b
    };
    var S = function() {
    ...
    S.prototype = {
        ...
        setInternal: function(a, b, c, h) {
            ...
            (null != E[b] ? a.existsReserved(b) :
                a.h.hasOwnProperty(b)) || (d = [], null != E[b] ? a.setReserved(b, d) : a.h[b] = d);
        ...
        renderDataType: function(a) {
            for (var b = [], c = 0, h = 0, d = a.length; h < d;) {
                var g = h++,
                    e = a[g];
                if (null != e) {
                    var f = "";
    ...
    v.prototype = {
        ...
        increaseTrackCount: function() {
            ...
            500 < this.session.getTrackCount() && A._raiseError("Google Analytics does not guarantee to process more than 500 requests per session.",
        ...
        buildVisitorParameters: function(a) {
            null != this.visitor.getLocale() &&
            (a.utmul = w.replace(this.visitor.getLocale(), "_", "-").toLowerCase());
        ...
        buildCustomVariablesParameter: function(a) {
            ...
            if (null == b) return a;
            5 < b.length && A._raiseError("The sum of all custom variables cannot exceed 5 in any given request.",
    ...
    W.prototype = l(v.prototype, {
        ...
        buildParameters: function() {
            var a =
                v.prototype.buildParameters.call(this);
    ...
    X.prototype = {
        ...
        request: function(a) {
                ...
                h = function(a) {
                    if (4 == c.readyState) {
                        ...
                        try {
                            ...
                            Va instanceof m && (Va = Va.val), d = null
                        }
            ...
            if (null != d) a = !0;
                ...
                for (var g = this.params.h, e = null; null != g;) e = g[0], g = g[1], d = null == d ? "" : d + "&", d += encodeURIComponent(e.param) + "=" + encodeURIComponent(e.value);
            try {
            ...
            }) && a && null == this.postData &&
            c.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
            a = this.headers.h;
            for (g = null; null != a;) g = a[0], a = a[1], c.setRequestHeader(g.header, g.value);
            c.send(d);
            this.async || h(null)
        },
        onData: function(a) {},
    ...
    var H = {
        __ename__: !0,
        __constructs__: ["Blocked", "Overflow", "OutsideBounds",
            "Custom"
        ],
        Blocked: ["Blocked", 0]
    };
    ...
    H.Overflow = ["Overflow", 1];
    H.Overflow.toString = F;
    H.Overflow.__enum__ = H;
    H.OutsideBounds = ["OutsideBounds", 2];
    ...
    P.doParse = function(a, b, c, d) {
        null == c && (c = 0);
        for (var h = null, e = 1, f = 1, l =
            null, p = 0, r = 0, t = 0, k = a.charCodeAt(c), n = new O, u = 1, v = -1; k == k;) {
            switch (e) {
                case 0:
                    switch (k) {
                        case 10:
                    ...
                    switch (k) {
                        case 33:
                            if (91 ==
                                ...
                                if (45 != a.charCodeAt(c + 1) || 45 != a.charCodeAt(c + 2)) throw new m("Expected \x3c!--");
                                c += 2;
                                e = 15
                            }
                            p = c + 1;
                ...
                case 8:
                    switch (k) {
                        ...
                        case 60:
                            if (b) throw new m("Invalid unescaped " + String.fromCharCode(k) + " in attribute value");
                            k == v && (n.addSub(a, p, c - p), f = n.b, n =
                                new O, h.set(l, f), e = 0, f = 4);
                            break;
                        default:
                            k == v && (n.addSub(a, p, c - p), f = n.b, n = new O, h.set(l, f), e = 0, f = 4)
                    }
                ...
                case 12:
                    switch (k) {
                        case 62:
                            return 0 == r && d.addChild(g.createPCData("")), c;
                        default:
                            throw new m("Expected >");
                    }
                case 10:
                ...
                case 16:
                    ...
                    break;
                case 14:
                    63 == k && 62 == a.charCodeAt(c + 1) && (c++, k = q.substr(a, p + 1, c - p - 2), k = g.createProcessingInstruction(k),
                        d.addChild(k), r++, e = 1);
                    break;
                case 18:
                    if (59 == k) {
                        p = q.substr(a, p, c - p);
                        if (35 == p.charCodeAt(0)) p = 120 == p.charCodeAt(1) ? J.parseInt("0" + q.substr(p, 1, p.length - 1)) : J.parseInt(q.substr(p, 1, p.length - 1)), n.b += String.fromCharCode(p);
        ...
        1 == e && (p = c, e = 13);
        if (13 == e) {
            if (c != p || 0 == r) n.addSub(a, p, c - p), a = g.createPCData(n.b), d.addChild(a);
            return c
        }
        if (!b && 18 == e && 13 == u) return n.b += "&", n.addSub(a, p, c - p), a = g.createPCData(n.b), d.addChild(a), c;
        ...
        switch (c) {
            case "object":
                if (a instanceof Array) {
                    ...
                    d = "[";
                    b += "\t";
                    for (e = 0; e < c;) g = e++, d += (0 < g ? "," : "") + z.__string_rec(a[g], b);
                    return d + "]"
                }
                try {
                    d = a.toString
    ...
    var L = function(a) {
        if (a instanceof Array && null ==
            a.__enum__) this.a = a, this.byteLength = a.length;
        else {
            this.a = [];
            for (var b = 0; b < a;) {
                var c = b++;
    ...
    T._new = function(a, b, c) {
        if ("number" == typeof a) {
            ...
            c.byteOffset =
                0;
            c.buffer = new L(c)
        } else if (z.__instanceof(a, L)) null == b && (b = 0), null == c && (c = a.byteLength - b), c = 0 == b ? a.a : a.a.slice(b, b + c), c.byteLength = c.length, c.byteOffset = b, c.buffer = a;
        else if (a instanceof Array && null == a.__enum__) c = a.slice(), c.byteLength = c.length, c.byteOffset = 0, c.buffer = new L(c);
    ...
    ma.prototype = {
        ...
        getJson: function() {
            return '{"title":"' + w.replace(this.title, '"', "'") + '","artist":"' + w.replace(this.artist, '"', "'") + '","album":"' + w.replace(this.album, '"', "'") + '","genre":"' + w.replace(this.genre, '"', "'") + '","comment":"' + w.replace(this.comment, '"',
                    "'") + '","encoder":"' + w.replace(this.encoder, '"', "'") + '","year":"' + w.replace(this.year, '"', "'") + '"}'
        },
        __class__: ma
    };
    var r = function() {};
    ...
    Sa.prototype = {
        ...
        begin: function() {
            "icecast" != this.metadataMode && "streamtheworld" != this.metadataMode && "shoutcast" != this.metadataMode || null != this.timer || (this.timer = new N(1E3 * this.interval), this.timer.run = u(this, this.loop), this.loop())
        console.log("i begin");
            console.log(this.metadataMode);
    ...
    G.prototype = {
        ...
        retryAudio: function(a) {
            null == a && (a = 5E3);
            var b = this; - 1 != this.lastAudioStatus && (this.lastAudioStatus = -1, N.delay(function() {
        ...
        setVolume: function(a, b) {
            ...
            null != this.ui && this.ui.setVolume(this.lastVolume,
                b)
        },
        checkAudioStatus: function() {
            ...
            0 == a ? (a = "Error al conectar", this.lastMessage != a && this.ui.setError()) : -1 == a ? a = "retry..." : null == a ? a = "init" : 1 == a ?
    ...
    var C = f.muses.UI = function(a, b) {
        ...
        this.mainDiv.addEventListener("contextmenu",
    ...
    C.prototype = {
        ...
        setMetadataFromString: function(a) {
            if (this.muses.isPlaying() && this.lastMetadata != a) {
                var b = a.indexOf(" - ", 0); - 1 != b ? (this.artistText.setText(q.substr(a,
                    0, b)), this.songTitleText.setText(q.substr(a, b + 3, null))) : (this.artistText.setText(""), this.songTitleText.setText(a));
                this.lastMetadata = a;
        ...
        showInfo: function(a,
                           b) {
            null == b && (b = !0);
            null == a ? this.restoreTitle() : (null != this.titleTimer && this.titleTimer.stop(), this.statusText.setText(a), b && (this.titleTimer = new N(2E3), this.titleTimer.run = u(this, this.restoreTitle)))
        },
    ...
    D.prototype = {
        ...
        configure: function(a) {
            ...
            null != a.get("height") && (this.container.style.height =
                this.styleHeight + "px")
        },
    ...
    da.prototype = l(D.prototype, {
        ...
        noMouseState: null,
        configure: function(a) {
            D.prototype.configure.call(this,
                a);
    ...
    Y.prototype = l(D.prototype, {
        ...
        configureText: function(a, b) {
            this.configure(a);
            this.innerDIV.style.fontFamily =
                a.get("font");
    ...
    oa.prototype = l(D.prototype, {
        ...
        mouseDown: function(a) {
            ...
            this.mousePressed = !0;
            a = this.getXY(a);
            null != a && ("vholder" != this.mode ? (a = a.x, b = this.width) : (a = this.height - a.y, b = this.height), a -= .06 * b, 0 > a && (a = 0), a = Math.round(1.06 * a), a > b && (a = b), this.setVolume(a / (b - 2)))
        },
        mouseUp: function(a) {
            this.mousePressed = !1
        },
        ...
        configure: function(a) {
            ...
            if ("holder" == b || "vholder" == b) this.holder = new Image,
                this.holder.onload = u(this, this.holderLoad), this.ui.loadImage(this.holder, a.get("holderimage")), this.appendChild(this.holder);
            this.draw(this.container);
    ...
    var ab = 0;
    Array.prototype.indexOf && (q.indexOf = function(a, b, c) {
    ...
    var db = {
        ...
        E = {},
        Wa = x.ArrayBuffer || L;
    null == Wa.prototype.slice && (Wa.prototype.slice = L.sliceImpl);
    var $a = x.Uint8Array ||
        T._new;
    d.objectId = "MRPObject";
    d.flashInstances = new n;
    d.jsInstances = new n;
    d.__hostPrefix = "hosted";
    d.__hostMidfix = "muses";
    g.Element = 0;
    g.PCData = 1;
    g.CData = 2;
    g.Comment = 3;
    ...
    g.Document = 6;
    Q.ERROR_SEVERITY_SILENCE = 0;
    Q.ERROR_SEVERITY_TRACE = 1;
    Q.ERROR_SEVERITY_EXCEPTIONS = 2;
    ha.REFERRER_INTERNAL = "0";
    t.paused = !1;
    A.VERSION = "5.2.5";
    S.OBJECT_KEY_NUM = 1;
    S.TYPE_KEY_NUM = 2;
    ...
    S.VALUE_VALUE_NUM = 1;
    v.TYPE_EVENT = "event";
    v.TYPE_TRANSACTION = "tran";
    v.TYPE_ITEM = "item";
    v.TYPE_SOCIAL =
        "social";
    v.TYPE_CUSTOMVARIABLE = "var";
    v.X10_CUSTOMVAR_NAME_PROJECT_ID = "8";
    v.X10_CUSTOMVAR_VALUE_PROJECT_ID = "9";
    v.X10_CUSTOMVAR_SCOPE_PROJECT_ID = "11";
    v.CAMPAIGN_DELIMITER = "|";
    ba.X10_EVENT_PROJECT_ID = "5";
    new Qa(0, 0);
    P.escapes = function(a) {
        a = new n;
...
if ("undefined" == typeof musesPlayerCounter) {
    ...
    (function() {
        ...
        0 < e() && 11 > e() || (e = document.createElement("audio"), mrpBrowserCompat.aac = !(!e.canPlayType || !e.canPlayType("audio/mp4;").replace(/no/, "")), mrpBrowserCompat.mp3 = !(!e.canPlayType || !e.canPlayType("audio/mpeg;").replace(/no/,
...
var FlashDetect = new function() {
    ...
    var f = [{
            ...
            version: function(e) {
                var f = "6,0,21";
                try {
                    e.AllowScriptAccess = "always", f = x(e)
                } catch (u) {}
                return f
            }
        }, {
    ...
    e.versionAtLeast = function(f) {
        var l = [e.major, e.minor, e.revision],
    ...
    e.FlashDetect = function() {
        ...
        if (navigator.plugins && 0 < navigator.plugins.length) {
            ...
            if (q && q["application/x-shockwave-flash"] && q["application/x-shockwave-flash"].enabledPlugin &&
                q["application/x-shockwave-flash"].enabledPlugin.description) {
            ...
            for (q = -1, K = 0; K < f.length && -1 == q; K++) {
                ...
                l.activeXError ||
                (e.installed = !0, q = f[K].version(l), -1 != q && (l = q, F = l.split(","), x = parseInt(F[0].split(" ")[1], 10), u = parseInt(F[1], 10), M = parseInt(F[2], 10), F = F[2], e.raw = l, e.major = x, e.minor = u, e.revision = M, e.revisionStr = F))
            }
    }()
};
